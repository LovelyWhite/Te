...
class DashBoard extends View {
    ...
    private double mMin = 0; // 最小值
    private double mMax = 20; // 最大值
    ...
    private String mLeftText="数值：";//下标文字
    ...
    public DashBoard(Context context, AttributeSet attrs) {
        ...
        TypedArray t = getContext().obtainStyledAttributes(attrs,
                R.styleable.DashBoard);
        this.mHeaderText = t.getString(R.styleable.DashBoard_headerText);
        this.mLeftText = t.getString(R.styleable.DashBoard_leftText);
        t.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
         ...
         * 画指针
         */
        double θ = mStartAngle + mSweepAngle * (mRealTimeValue - mMin) / (mMax - mMin); // 指针与水平线夹角
    ...
    public float[] getCoordinatePoint(int radius, double angle) {
